...
namespace SolidCRM.Web
{
    public static class sHtmlHelper
    {
        ...
        { 
            ...
            sb.AppendLine("                                             <li><a onclick=\"copy('+ data +')\" title=\"Create New Copy\" style=\"cursor: pointer;\"><i class=\"fa fa-copy\"></i>Copy</a> </li>\\");
        ...
        public static IHtmlContent DataTableRowDelete(this IHtmlHelper htmlHelper, string TableName)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder();
            ...
            sb.AppendLine("                        $.sticky('<br/>you are unauthorized to delete data', { stickyClass: 'error' });");
            sb.AppendLine("                    }");
            sb.AppendLine("                    else {");
            sb.AppendLine("                        $.sticky('<br/> Action Successfully Executed', { stickyClass: 'success' });");
            sb.AppendLine("                        var table2 = $('#tb" + TableName + "').DataTable();");
